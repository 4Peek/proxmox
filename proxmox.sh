...
qm importdisk 100 ISP-disk001.vmdk $STORAGE --format vmdk 
...
qm importdisk 101 RTR-HQ-disk001.vmdk $STORAGE --format vmdk 
...
qm importdisk 102 RTR-BR-disk001.vmdk $STORAGE --format vmdk 
